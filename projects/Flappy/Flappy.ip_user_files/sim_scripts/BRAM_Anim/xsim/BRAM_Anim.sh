...
#
# Script generated by Vivado on Thu Dec 05 14:54:26 +0800 2024
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : BRAM_Anim.sh
...
#
# Usage        : BRAM_Anim.sh
#                BRAM_Anim.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                BRAM_Anim.sh [-reset_run]
#                BRAM_Anim.sh [-reset_log]
#                BRAM_Anim.sh [-help]
#
...
# script info
echo -e "BRAM_Anim.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./BRAM_Anim.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot BRAM_Anim xil_defaultlib.BRAM_Anim xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim BRAM_Anim -key {Behavioral:sim_1:Functional:BRAM_Anim} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb BRAM_Anim.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./BRAM_Anim.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: BRAM_Anim.sh [-help]\n\
Usage: BRAM_Anim.sh [-step]\n\
Usage: BRAM_Anim.sh [-lib_map_path]\n\
Usage: BRAM_Anim.sh [-reset_run]\n\
Usage: BRAM_Anim.sh [-reset_log]\n\
Usage: BRAM_Anim.sh [-keep_index]\n\
Usage: BRAM_Anim.sh [-noclean_files]\n\n\
