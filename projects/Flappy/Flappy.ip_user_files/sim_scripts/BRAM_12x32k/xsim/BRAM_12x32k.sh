...
#
# Script generated by Vivado on Sun Dec 01 23:20:07 +0800 2024
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : BRAM_12x32k.sh
...
#
# Usage        : BRAM_12x32k.sh
#                BRAM_12x32k.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                BRAM_12x32k.sh [-reset_run]
#                BRAM_12x32k.sh [-reset_log]
#                BRAM_12x32k.sh [-help]
#
...
# script info
echo -e "BRAM_12x32k.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./BRAM_12x32k.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot BRAM_12x32k xil_defaultlib.BRAM_12x32k xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim BRAM_12x32k -key {Behavioral:sim_1:Functional:BRAM_12x32k} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb BRAM_12x32k.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./BRAM_12x32k.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: BRAM_12x32k.sh [-help]\n\
Usage: BRAM_12x32k.sh [-step]\n\
Usage: BRAM_12x32k.sh [-lib_map_path]\n\
Usage: BRAM_12x32k.sh [-reset_run]\n\
Usage: BRAM_12x32k.sh [-reset_log]\n\
Usage: BRAM_12x32k.sh [-keep_index]\n\
Usage: BRAM_12x32k.sh [-noclean_files]\n\n\
