...
#                script (type 'BROM_Bird22.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.BROM_Bird22 xil_defaultlib.glbl -o BROM_Bird22_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./BROM_Bird22_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key BROM_Bird22_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc BROM_Bird22_simv.daidir vcs_lib c.obj)
