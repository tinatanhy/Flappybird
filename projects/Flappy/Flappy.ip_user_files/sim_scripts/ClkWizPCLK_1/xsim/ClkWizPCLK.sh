...
#
# Script generated by Vivado on Sun Dec 01 23:56:24 +0800 2024
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : ClkWizPCLK.sh
...
#
# Usage        : ClkWizPCLK.sh
#                ClkWizPCLK.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ClkWizPCLK.sh [-reset_run]
#                ClkWizPCLK.sh [-reset_log]
#                ClkWizPCLK.sh [-help]
#
...
# script info
echo -e "ClkWizPCLK.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ClkWizPCLK.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ClkWizPCLK xil_defaultlib.ClkWizPCLK xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ClkWizPCLK -key {Behavioral:sim_1:Functional:ClkWizPCLK} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ClkWizPCLK.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ClkWizPCLK.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ClkWizPCLK.sh [-help]\n\
Usage: ClkWizPCLK.sh [-step]\n\
Usage: ClkWizPCLK.sh [-lib_map_path]\n\
Usage: ClkWizPCLK.sh [-reset_run]\n\
Usage: ClkWizPCLK.sh [-reset_log]\n\
Usage: ClkWizPCLK.sh [-keep_index]\n\
Usage: ClkWizPCLK.sh [-noclean_files]\n\n\
