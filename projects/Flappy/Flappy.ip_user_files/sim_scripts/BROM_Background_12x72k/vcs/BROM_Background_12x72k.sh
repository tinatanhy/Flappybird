...
#                script (type 'BROM_Background_12x72k.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.BROM_Background_12x72k xil_defaultlib.glbl -o BROM_Background_12x72k_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./BROM_Background_12x72k_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key BROM_Background_12x72k_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc BROM_Background_12x72k_simv.daidir vcs_lib c.obj)
