...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.BROM_Background_12x72k xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.BROM_Background_12x72k -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log BROM_Background_12x72k_sc.so .tmp_log xcelium_lib waves.shm c.obj)
