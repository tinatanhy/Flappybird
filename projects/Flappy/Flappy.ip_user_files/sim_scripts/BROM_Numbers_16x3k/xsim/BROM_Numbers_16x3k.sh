...
#
# Script generated by Vivado on Thu Dec 05 21:51:40 +0800 2024
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : BROM_Numbers_16x3k.sh
...
#
# Usage        : BROM_Numbers_16x3k.sh
#                BROM_Numbers_16x3k.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                BROM_Numbers_16x3k.sh [-reset_run]
#                BROM_Numbers_16x3k.sh [-reset_log]
#                BROM_Numbers_16x3k.sh [-help]
#
...
# script info
echo -e "BROM_Numbers_16x3k.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./BROM_Numbers_16x3k.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot BROM_Numbers_16x3k xil_defaultlib.BROM_Numbers_16x3k xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim BROM_Numbers_16x3k -key {Behavioral:sim_1:Functional:BROM_Numbers_16x3k} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb BROM_Numbers_16x3k.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./BROM_Numbers_16x3k.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: BROM_Numbers_16x3k.sh [-help]\n\
Usage: BROM_Numbers_16x3k.sh [-step]\n\
Usage: BROM_Numbers_16x3k.sh [-lib_map_path]\n\
Usage: BROM_Numbers_16x3k.sh [-reset_run]\n\
Usage: BROM_Numbers_16x3k.sh [-reset_log]\n\
Usage: BROM_Numbers_16x3k.sh [-keep_index]\n\
Usage: BROM_Numbers_16x3k.sh [-noclean_files]\n\n\
